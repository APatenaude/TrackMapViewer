...
const MESSAGES: Record<Lang, Record<string, string>> = {
	en: {
		...
		installGeneric:
			"Open your browser menu, or the install icon {icon} in the address bar, then choose Install or Add to Home Screen.",
		installTitleIos: "Add to Home Screen",
		installIos1: "Tap the Share button {icon} at the bottom of Safari",
		installIos2: "Scroll down and tap Add to Home Screen {icon}",
	...
	fr: {
		...
		installGeneric:
			"Ouvrez le menu de votre navigateur, ou l'icône d'installation {icon} dans la barre d'adresse, puis choisissez Installer ou Ajouter à l'écran d'accueil.",
		installTitleIos: "Sur l'écran d'accueil",
		installIos1: "Touchez le bouton Partager {icon} en bas de Safari",
		installIos2: "Faites défiler et touchez Ajouter à l'écran d'accueil {icon}",
